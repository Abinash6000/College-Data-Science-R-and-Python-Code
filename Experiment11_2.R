...
# Read excel file
df <- read.xlsx("C:/Users/admin/Downloads/Experience_Salary.xlsx", sheetName = "Sheet1")
...
# plot(Salary~YearsExperience, data=df, col="red")
# boxplot(df$Salary, col='red')
# boxplot(df$YearsExperience, col='green')
...
plot(Salary~YearsExperience, main=eq, data=train)
